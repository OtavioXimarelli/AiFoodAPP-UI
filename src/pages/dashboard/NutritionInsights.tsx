...
const NutritionInsights = () => {
  ...
  const basicTotals = safeFoodItems.reduce(
    (acc, item) => {
      return {
  ...
  const foodGroups = safeFoodItems.reduce(
    (acc, item) => {
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground text-lg max-w-md mx-auto">
                    Adicione alimentos à sua despensa para ver insights nutricionais detalhados e
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground">
                      Conecte com seu backend para análises nutricionais detalhadas, gráficos
            ...
            <CardContent className="space-y-4">
              {Object.entries(foodGroups).map(([group, count]) => {
                ...
                return (
                  <div
                    key={group}
                    className="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-background/50 to-accent/10 border border-border/20 hover:border-border/40 transition-all duration-300"
                  >
                    ...
                    <Badge
                      variant="outline"
                      className="px-3 py-1 rounded-full font-medium border-primary/20 text-primary"
                    >
