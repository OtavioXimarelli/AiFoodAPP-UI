          ...
          actions={
            <>
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  {canGenerateRecipes
                    ? 'Gerar receitas com seus ingredientes'
                    : 'Adicione ingredientes para habilitar'}
                </TooltipContent>
              </Tooltip>
            </>
          }
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                          {foodItems.map(item => (
                            <Badge
                              key={item.id}
                              variant="outline"
                              className="justify-center py-2 px-3 bg-background/50"
                            >
                  ...
                  <div className="flex flex-col items-center justify-center space-y-4">
                    ...
                    <div className="text-center space-y-2">
                      <h3 className="text-lg font-semibold text-foreground">
                        IA Criando Receitas Personalizadas
                      </h3>
                      <p className="text-muted-foreground">
                        Analisando seus ingredientes e criando receitas únicas...
                      </p>
            ...
            {recipes.length > 0 && !showHistory && (
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="outline" onClick={clearRecipes} size="sm" className="gap-2">
                ...
                <div className="grid gap-4 md:gap-6">
                  {recipes.map((recipe, index) => (
                    <Card
                      key={recipe.id}
                      className="bg-card border-border/50 hover:shadow-lg hover:shadow-primary/10 transition-all duration-300 overflow-hidden"
                    >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mb-4">
                        Adicione alguns ingredientes à sua despensa primeiro para gerar receitas
                        personalizadas.
                      </p>
                ...
                <CardContent className="p-8 sm:p-12 text-center">
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mb-4">
                        Você tem {foodItems.length} ingredientes disponíveis. Clique no botão acima
