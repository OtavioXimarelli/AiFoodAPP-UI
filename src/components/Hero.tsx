          ...
          <AnimatedElement variant="slideLeft" delay={0.4} className="relative">
            ...
            <div className="relative w-full max-w-lg mx-auto">
              ...
              <ClickSpark count={10} color="hsl(var(--primary))">
                <ReactBitsCard
                  variant="tilt"
                  className="transform rotate-2 hover:rotate-0 transition-transform duration-500 will-change-transform"
                >
              ...
              <AnimatedElement variant="scale" delay={0.8} className="absolute -top-6 -right-6">
                <ReactBitsCard
                  variant="magnetic"
                  className="transform -rotate-6 hover:rotate-0 transition-transform duration-500 will-change-transform"
                >
                  <div className="bg-green-50 dark:bg-green-900/20 rounded-2xl border border-green-200 dark:border-green-800 shadow-lg p-4">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-green-600 dark:text-green-400">
                        {avgCalories ? 'Média de calorias' : 'Calorias (exemplo)'}{' '}
                      </div>
                    </div>
                  </div>
                </ReactBitsCard>
              ...
              <AnimatedElement variant="scale" delay={1} className="absolute -bottom-4 -left-8">
                <ReactBitsCard
                  variant="hover-glow"
                  className="transform rotate-3 hover:rotate-0 transition-transform duration-500 will-change-transform"
                >
                  <div className="bg-orange-50 dark:bg-orange-900/20 rounded-2xl border border-orange-200 dark:border-orange-800 shadow-lg p-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="text-sm font-medium text-orange-600 dark:text-orange-400">
                        {totalIngredients} {totalIngredients === 1 ? 'Ingrediente' : 'Ingredientes'}
                      </div>
                    </div>
                  </div>
                </ReactBitsCard>
