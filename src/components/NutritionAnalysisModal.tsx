        ...
        <div className="space-y-6 py-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {nutritionMetrics.map((metric, index) => (
              <Card key={index} className="border-border/30 hover:shadow-md hover:scale-[1.02] transition-all duration-200">
          ...
          {structuredAnalysis.suggestions.length > 0 && (
            <Card className="border-border/30 bg-green-50/50 dark:bg-green-900/10">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg">
          ...
          {structuredAnalysis.warnings.length > 0 && (
            <Card className="border-border/30 bg-amber-50/50 dark:bg-amber-900/10">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg">
          ...
          {/* Full Analysis Text as fallback */}
          <Card className="border-border/30">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-lg">
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                {recipe.ingredientsList.map((ingredient) => (
                  <Badge key={ingredient.id} variant="outline" className="justify-center py-2 px-3">
